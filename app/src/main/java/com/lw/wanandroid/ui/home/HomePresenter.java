...
public class HomePresenter extends BasePresenter<HomeContract.View> implements HomeContract.Presenter {
    ...
    public void loadHomeData() {
        ...
        Observable.zip(observableBanner, observableArticle, new BiFunction<DataResponse<List<Banner>>, DataResponse<Article>, Map<String, Object>>() {
            @Override
            public Map<String, Object> apply(DataResponse<List<Banner>> dataResponse, DataResponse<Article> dataResponse2) throws Exception {
